...
export default function BlogPost() {
  const relatedPosts = blogPosts.filter(p => p.slug !== 'wix-seo-best-practices-guide').slice(0, 4)
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            Wix claims to be SEO-friendly. This honest review shows what works, what doesn\'t, and when to switch platforms.
          </p>
