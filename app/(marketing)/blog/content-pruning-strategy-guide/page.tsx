...
export default function BlogPost() {
  const relatedPosts = blogPosts.filter(post =>
    ["duplicate-content-solutions-guide","crawl-budget-optimization-guide","site-architecture-seo-best-practices"].includes(post.slug)
  ).slice(0, 4)
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-sm text-slate-400 mb-6">
            ...
            {' '}/{' '}
            <span>Content Pruning</span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent leading-tight">
            Content Pruning: Delete Old Content to Boost Rankings
          </h1>
          ...
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            Outdated content drags down your site. This pruning strategy increased organic traffic by 73% in 60 days.
          </p>
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-12 rounded-r-lg">
              ...
              <p className="text-slate-700 mb-0">
                Outdated content drags down your site. This pruning strategy increased organic traffic by 73% in 60 days. SEOLOGY automates this entire optimization process—delivering proven results without manual work.
              </p>
            </div>
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-lg text-slate-700 leading-relaxed">
                  Content Pruning is critical for modern SEO success. Here's why this optimization drives real rankings and revenue:
                </p>
              ...
              <section>
                ...
                <p className="text-lg text-slate-700 leading-relaxed mb-4">
                  Follow this proven framework to implement content pruning correctly:
                </p>
              ...
              <section>
                ...
                <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-8 rounded-2xl text-white">
                  <h3 className="text-2xl font-bold mb-4">Automate Your Content Pruning Optimization</h3>
                  <p className="text-lg mb-6 opacity-90">
                    SEOLOGY implements content pruning automatically—boosting rankings without manual work.
                  </p>
                  <Link
                    href="/sign-up"
              ...
              <section>
                <p className="text-sm text-slate-500">
                  <strong>Tags:</strong> #SEO #content #SEOLOGY #SEOAutomation
                </p>
              </section>
            </div>
          </div>
