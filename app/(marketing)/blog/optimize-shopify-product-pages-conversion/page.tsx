    ...
    <article className="mx-auto max-w-4xl px-4 py-12">
      ...
      <header className="mb-12 border-b border-neutral-200 pb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-semibold text-neutral-900">Lisa Thompson</p>
            <p className="text-sm text-neutral-600">Conversion Optimization Lead at SEOLOGY.AI</p>
          </div>
        </div>
      </header>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="mb-12 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 p-8 not-prose">
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-xl bg-white border-2 border-red-200 p-6">
              ...
              <div className="border-t-2 border-red-300 pt-4">
                <p className="mb-1 text-xs text-neutral-600">Annual Revenue</p>
            ...
            <div className="rounded-xl bg-white border-2 border-green-200 p-6">
              ...
              <div className="border-t-2 border-green-300 pt-4">
                <p className="mb-1 text-xs text-neutral-600">Annual Revenue</p>
                <p className="text-3xl font-bold text-green-600">$489,600</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-neutral-900 p-8 text-center text-white">
            ...
            <p className="text-sm opacity-90">
              That's the power of product page optimization. Same visitors, same products, massively different revenue.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 space-y-4 not-prose">
          <div className="rounded-lg border-l-4 border-green-500 bg-green-50 p-6">
            ...
            <ul className="space-y-1 text-sm text-green-800">
              <li>• 7+ high-quality product images (multiple angles + lifestyle shots)</li>
              <li>• 400-600 word unique product descriptions (not manufacturer copy)</li>
              <li>• Customer reviews visible above the fold (4.5+ star average)</li>
              <li>• Product videos under 60 seconds showing product in use</li>
              <li>• Mobile load time under 2.5 seconds</li>
          ...
          <div className="rounded-lg border-l-4 border-red-500 bg-red-50 p-6">
            ...
            <ul className="space-y-1 text-sm text-red-800">
              <li>• 1-3 low-quality images (product on white background only)</li>
              <li>• 50-150 word generic descriptions (copy-pasted from manufacturer)</li>
              <li>• No reviews or reviews hidden at bottom of page</li>
              <li>• No videos or product demonstration</li>
              <li>• Mobile load time 5+ seconds (customers bounce)</li>
              <li>• No trust signals (customers don't feel safe buying)</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-10 rounded-xl border-2 border-purple-200 bg-purple-50 p-8 not-prose">
          ...
          <div className="mb-6 rounded-lg bg-white p-6">
            ...
            <ul className="space-y-2 text-sm text-neutral-700">
              <li>• <strong>Minimum 7 images</strong> per product (studies show 5-7 images is the sweet spot)</li>
              <li>• <strong>Multiple angles:</strong> front, back, sides, top, bottom, detail shots</li>
              <li>• <strong>Lifestyle photos:</strong> product being used in real-world context</li>
              <li>• <strong>Size comparison:</strong> product next to familiar object (coffee cup, hand, ruler)</li>
              <li>• <strong>Detail shots:</strong> close-ups of texture, materials, craftsmanship</li>
              <li>• <strong>360° view or video:</strong> allows customers to "inspect" the product</li>
              <li>• <strong>High resolution:</strong> 2000x2000px minimum (zoomable on desktop)</li>
        ...
        <div className="mb-10 rounded-xl border-2 border-blue-200 bg-blue-50 p-8 not-prose">
            ...
            <div className="space-y-4 text-sm">
              <div className="rounded border-l-4 border-blue-500 bg-blue-50 p-4">
                ...
                <p className="text-neutral-700">
                  Biggest benefit + emotional appeal. Example: "Sleep better tonight in sheets that feel like a luxury
              ...
              <div className="rounded border-l-4 border-green-500 bg-green-50 p-4">
                ...
                <p className="text-neutral-700">
                  What pain does this solve? Example: "Tired of waking up hot and sweaty? Most sheets trap heat and
              ...
              <div className="rounded border-l-4 border-purple-500 bg-purple-50 p-4">
                ...
                <p className="text-neutral-700">
                  How your product solves the problem. Use bullet points for features, paragraphs for benefits.
              ...
              <div className="rounded border-l-4 border-pink-500 bg-pink-50 p-4">
                ...
                <p className="text-neutral-700">
                  Remove risk: "Try risk-free with our 100-night sleep trial. Love them or return for full refund."
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 rounded-lg bg-red-50 border-2 border-red-200 p-6">
            ...
            <ul className="space-y-2 text-sm text-red-800">
              <li>• Using manufacturer descriptions (Google penalizes duplicate content)</li>
              <li>• Writing under 200 words (Google considers this "thin content")</li>
              <li>• Focusing only on features, not benefits ("300 thread count" vs "feels luxuriously soft")</li>
              <li>• Using generic language ("high quality, great value, amazing product")</li>
        ...
        <div className="mb-10 space-y-6 not-prose">
          <div className="rounded-lg border-2 border-green-200 bg-green-50 p-6">
            <div className="mb-3 flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-green-600 text-lg font-bold text-white">3</span>
              <h4 className="text-xl font-bold text-green-900">Clear, Prominent Call-to-Action (15% Impact)</h4>
            </div>
            <p className="mb-3 text-sm text-neutral-700">
              Your "Add to Cart" button should be impossible to miss. Use contrasting colors, make it large (minimum 44x44px
              for mobile), and keep the text action-oriented.
            </p>
            <ul className="space-y-1 text-sm text-neutral-600">
              <li>• <strong>Good CTAs:</strong> "Add to Cart" / "Buy Now" / "Get Yours Today"</li>
              <li>• <strong>Bad CTAs:</strong> "Submit" / "Continue" / "Proceed"</li>
          ...
          <div className="rounded-lg border-2 border-orange-200 bg-orange-50 p-6">
            <div className="mb-3 flex items-center gap-3">
              ...
              <h4 className="text-xl font-bold text-orange-900">Customer Reviews & Ratings (12% Impact)</h4>
            </div>
            <p className="mb-3 text-sm text-neutral-700">
              Display star rating and review count ABOVE the fold. Products with 50+ reviews convert 270% better than
              products with zero reviews.
            </p>
            <ul className="space-y-1 text-sm text-neutral-600">
              <li>• <strong>Optimal review count:</strong> 50-200 reviews (more credible than 5, less overwhelming than 5,000)</li>
              <li>• <strong>Star rating sweet spot:</strong> 4.3-4.7 stars (4.9+ looks fake, below 4.0 raises concerns)</li>
          ...
          <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6">
            <div className="mb-3 flex items-center gap-3">
              ...
              <h4 className="text-xl font-bold text-purple-900">Product Videos (10% Impact)</h4>
            </div>
            <p className="mb-3 text-sm text-neutral-700">
              Video increases conversion by 80%. Keep videos under 60 seconds, show product in use, include captions
              (85% of people watch videos muted).
            </p>
            <ul className="space-y-1 text-sm text-neutral-600">
              <li>• <strong>Best video types:</strong> Unboxing, product demo, before/after, customer testimonials</li>
              <li>• <strong>Mobile optimization:</strong> Vertical (9:16) format converts 91% better on mobile</li>
          ...
          <div className="rounded-lg border-2 border-teal-200 bg-teal-50 p-6">
            <div className="mb-3 flex items-center gap-3">
              ...
              <h4 className="text-xl font-bold text-teal-900">Trust Badges & Security Signals (8% Impact)</h4>
            </div>
            <p className="mb-3 text-sm text-neutral-700">
              Display trust badges near "Add to Cart" button. Common badges: free shipping, secure checkout, money-back
              guarantee, satisfaction guarantee, payment icons.
            </p>
            <ul className="space-y-1 text-sm text-neutral-600">
              <li>• <strong>Free shipping badge:</strong> Increases conversion by 55% (even if shipping isn't free below $X)</li>
              <li>• <strong>Money-back guarantee:</strong> Reduces perceived risk, increases AOV by 18%</li>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg bg-white/10 p-4">
              ...
              <ul className="space-y-1 text-sm opacity-90">
                <li>• Swipeable gallery (not click to zoom)</li>
                <li>• Tap to expand to full screen</li>
            ...
            <div className="rounded-lg bg-white/10 p-4">
              ...
              <ul className="space-y-1 text-sm opacity-90">
                <li>• Sticky "Add to Cart" at bottom</li>
                <li>• Minimum 44x44px (thumb-friendly)</li>
        ...
        <div className="mb-8 space-y-4 not-prose">
          <div className="rounded-lg bg-green-50 border-l-4 border-green-500 p-6">
            ...
            <p className="mb-2 text-sm text-neutral-700">
              Hypothesis: Video auto-plays when product page loads (muted), placed before image gallery.
            </p>
          ...
          <div className="rounded-lg bg-blue-50 border-l-4 border-blue-500 p-6">
            ...
            <p className="mb-2 text-sm text-neutral-700">
              Hypothesis: "Sale ends in 4 hours 23 minutes" countdown creates urgency without being pushy.
            </p>
          ...
          <div className="rounded-lg bg-purple-50 border-l-4 border-purple-500 p-6">
            ...
            <p className="mb-2 text-sm text-neutral-700">
              Hypothesis: Show 6-12 customer-uploaded photos before official product images.
            </p>
            <p className="text-sm font-semibold text-purple-800">
              Result: +22% conversion, +67% time on page (customers engage longer)
            </p>
          </div>
        </div>
        ...
        <div className="mb-12 rounded-2xl bg-neutral-900 p-12 text-white not-prose">
          ...
          <div className="mb-8 rounded-xl bg-white/10 p-8">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between opacity-90">
                <span>A/B test variations and analyze</span>
              ...
              <div className="border-t border-white/20 pt-3 flex justify-between text-lg font-bold">
                ...
                <span className="text-red-400">264 hours</span>
              </div>
            </div>
            <p className="mt-6 text-center opacity-75">
          ...
          <div className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 p-8 text-center">
            ...
            <ul className="mb-6 space-y-2 text-left text-sm">
              <li>✓ Rewrites all 200 product descriptions (unique, SEO-optimized, conversion-focused)</li>
              <li>✓ Optimizes and compresses all images automatically</li>
              <li>✓ Generates descriptive alt text for every image</li>
              <li>✓ Creates perfect meta titles and descriptions</li>
              <li>✓ Runs continuous A/B tests in background</li>
              <li>✓ Ensures mobile optimization across all products</li>
            </ul>
            <p className="text-lg font-semibold">
              Save 264 hours. Get better results. That's the power of AI automation.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12 rounded-2xl bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 p-12 text-center text-white not-prose">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-white px-8 py-4 text-lg font-bold text-purple-600 shadow-xl hover:bg-neutral-50 hover:shadow-2xl transition-all"
            >
        ...
        <div className="border-t border-neutral-200 pt-8 not-prose">
          ...
          <div className="flex gap-6">
            <div className="h-16 w-16 flex-shrink-0 rounded-full bg-purple-100"></div>
            <div>
              <p className="mb-2 font-bold text-neutral-900">Lisa Thompson</p>
              <p className="mb-3 text-sm text-neutral-600">
                Conversion Optimization Lead at SEOLOGY.AI with 11+ years specializing in ecommerce product page
                optimization. Lisa has personally optimized 50,000+ product pages, achieving an average conversion
                rate increase of 187% across client stores.
              </p>
              <p className="text-sm text-neutral-600">
                Previously led CRO at two 9-figure Shopify Plus brands, managing $200M+ in annual GMV. Certified
                in Google Analytics, behavioral psychology, and A/B testing methodology.
              </p>
            </div>
          </div>
        </div>
