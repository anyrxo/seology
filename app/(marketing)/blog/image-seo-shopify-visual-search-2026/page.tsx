export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    tags: ['Image SEO', 'Visual Search', 'Google Lens', 'WebP', 'AVIF', 'Core Web Vitals', 'Product Photography', 'Shopify SEO'],
  },
}
    ...
    <article className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-12">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
            NP
          </div>
          <div>
            <h3 className="font-bold text-lg mb-1 text-gray-900 dark:text-gray-100">Nina Patel</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Visual Search Specialist & Image Optimization Expert</p>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-12">
        ...
        <ul className="space-y-2 text-blue-600 dark:text-blue-400">
          <li><a href="#visual-search-revolution" className="hover:underline">The Visual Search Revolution: 2026 Statistics</a></li>
          <li><a href="#google-lens-optimization" className="hover:underline">Google Lens Optimization for Shopify</a></li>
          <li><a href="#image-formats" className="hover:underline">Next-Gen Image Formats: WebP vs AVIF</a></li>
          <li><a href="#core-web-vitals" className="hover:underline">Images and Core Web Vitals (LCP)</a></li>
          <li><a href="#alt-text-strategy" className="hover:underline">Alt Text Strategy That Ranks</a></li>
          <li><a href="#structured-data" className="hover:underline">Image Structured Data for Rich Results</a></li>
          <li><a href="#file-naming" className="hover:underline">SEO-Friendly File Naming Conventions</a></li>
          <li><a href="#image-sitemaps" className="hover:underline">Image Sitemaps for Discovery</a></li>
          <li><a href="#compression-techniques" className="hover:underline">Compression Without Quality Loss</a></li>
          <li><a href="#mobile-optimization" className="hover:underline">Mobile-First Image Optimization</a></li>
          <li><a href="#pinterest-instagram" className="hover:underline">Pinterest & Instagram Visual Search</a></li>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <div className="bg-purple-50 dark:bg-purple-950/30 border-l-4 border-purple-500 rounded-lg p-8 my-8">
          ...
          <ul className="space-y-3 text-gray-700 dark:text-gray-300">
            <li><strong>20 billion</strong> visual searches per month on Google Lens alone</li>
            <li><strong>4 billion</strong> of those searches are shopping-related</li>
            <li><strong>35%</strong> of ecommerce search functions will be visual by 2026</li>
            <li><strong>40%</strong> of Gen Z shoppers prefer image search over text</li>
            <li><strong>87%</strong> of Pinterest users made a purchase after using visual search</li>
            <li><strong>55%</strong> of consumers more likely to engage with brands offering visual search</li>
            <li><strong>38% YoY growth</strong> in image-based apparel searches</li>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Surrounding text:</strong> Product titles, descriptions, headings near images</li>
          <li><strong>Image metadata:</strong> File names, EXIF data, structured data</li>
        ...
        <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-6 my-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
            <li><strong>High-resolution images:</strong> Minimum 1200x1200px for product photos</li>
            <li><strong>Multiple angles:</strong> Front, back, side, detail shots (increases match accuracy)</li>
            <li><strong>Clean backgrounds:</strong> White or neutral backgrounds improve object detection</li>
            <li><strong>Proper lighting:</strong> Well-lit images with accurate color representation</li>
            <li><strong>Zoom capability:</strong> High-res images that reveal texture and detail</li>
            <li><strong>Context shots:</strong> Lifestyle images showing products in use</li>
            <li><strong>Consistent branding:</strong> Logo/watermark placement for brand recognition</li>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Lossless:</strong> 26% smaller than PNG</li>
          <li><strong>Decode speed:</strong> Faster rendering, especially on mobile devices</li>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Overall reduction:</strong> 30-70% smaller than original JPEG</li>
          <li><strong>Decode speed:</strong> Slower (requires more CPU, especially on mobile)</li>
  ...
  <img src="product.jpg" alt="Descriptive alt text" loading="lazy">
        ...
        <div className="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 rounded-lg p-8 my-8">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
            On <strong>73% of mobile pages</strong>, the Largest Contentful Paint (LCP) element is an image. Shrinking image file sizes <strong>directly improves your Core Web Vitals score</strong> and search rankings.
          </p>
          <p className="text-gray-700 dark:text-gray-300">
        ...
        <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Lazy load below-fold:</strong> <code>loading="lazy"</code> for images below the fold</li>
          <li><strong>Responsive images:</strong> Use <code>srcset</code> to serve appropriate sizes</li>
          <li><strong>CDN delivery:</strong> Image CDN for optimized delivery and automatic format selection</li>
          <li><strong>Compress aggressively:</strong> Aim for 30-70% file size reduction without visible quality loss</li>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Describe function:</strong> "Ergonomic office chair with lumbar support" beats "chair"</li>
          <li><strong>Mention brand (if relevant):</strong> Branded searches have 3.8x higher CTR</li>
          <li><strong>Context matters:</strong> "Woman wearing red dress at beach wedding" for lifestyle shots</li>
          <li><strong>125 characters max:</strong> Screen readers may cut off longer text</li>
    ...
    "availability": "https://schema.org/InStock"
        ...
        <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-6 my-8">
          ...
          <ul className="space-y-2 mt-4">
            ...
            <li><strong>Be descriptive:</strong> Color, style, material, season</li>
            <li><strong>Lowercase only:</strong> Avoid capital letters</li>
            <li><strong>No special characters:</strong> Stick to letters, numbers, hyphens</li>
        ...
        <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Geographic tags:</strong> Use <code>&lt;image:geo_location&gt;</code> for local products</li>
        ...
        <div className="overflow-x-auto my-6">
          <table className="min-w-full border border-gray-300 dark:border-gray-700">
            <thead className="bg-gray-100 dark:bg-gray-800">
              <tr>
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Image Type</th>
                ...
                <th className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-left">Target Size</th>
              </tr>
            </thead>
            <tbody className="text-gray-700 dark:text-gray-300">
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Hero image</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">WebP</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">85-90%</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">&lt;200KB</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Product main</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">WebP/AVIF</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">80-85%</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">&lt;150KB</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Product gallery</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">AVIF</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">75-80%</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">&lt;100KB</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Thumbnails</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">WebP</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">70-75%</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">&lt;30KB</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Background images</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">AVIF</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">65-70%</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">&lt;80KB</td>
              </tr>
            </tbody>
          </table>
        </div>
...
/>`}</code></pre>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Carousel posts:</strong> Multiple angles increase engagement 3.1x</li>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>☐ Audit current image formats (identify JPEG/PNG to convert)</li>
                <li>☐ Install image optimization app (TinyIMG, Crush.pics, or Optimole)</li>
                <li>☐ Convert all hero images to WebP with preload tags</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>☐ Write descriptive alt text for top 100 products (use formula above)</li>
                <li>☐ Rename image files with SEO-friendly names (color-style-material-keyword)</li>
                <li>☐ Add Product schema with image arrays to product pages</li>
                <li>☐ Verify image sitemap in Google Search Console</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>☐ Convert product gallery images to AVIF (below-fold)</li>
                <li>☐ Implement &lt;picture&gt; element with AVIF/WebP/JPEG fallbacks</li>
                <li>☐ Set up responsive images with srcset for all product photos</li>
                <li>☐ Compress images to target file sizes (see table above)</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>☐ Create Pinterest Business account and enable Rich Pins</li>
                <li>☐ Upload vertical product images (2:3 ratio) to Pinterest</li>
                <li>☐ Set up Instagram Shopping with product tags</li>
                <li>☐ Test Google Lens with your product images (search by image)</li>
                <li>☐ Monitor Google Search Console for image impressions/clicks</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-2xl p-12 my-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Link
              ...
              className="bg-white text-purple-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-50 transition-colors inline-block shadow-lg"
            >
              Start Free 14-Day Trial →
            </Link>
            <Link
              href="/demo"
              className="bg-purple-700 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-800 transition-colors inline-block border-2 border-white/30"
            >
              Watch Demo
            </Link>
          </div>
          ...
          <div className="flex items-center justify-center gap-8 text-sm text-purple-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>December 2025 special: 20% off annual plans</span>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose border-t border-gray-200 dark:border-gray-700 pt-8 mt-16">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1 text-gray-900 dark:text-gray-100">About the Author: Nina Patel</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Visual Search Specialist & Image Optimization Expert</p>
              <p className="text-sm text-gray-700 dark:text-gray-300">
