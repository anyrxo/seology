...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    tags: ['Structured Data', 'Schema Markup', 'Rich Snippets', 'Product Schema', 'Review Schema', 'FAQ Schema', 'JSON-LD', 'Shopify SEO'],
  },
}
    ...
    <article className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-12">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
            CM
          </div>
          <div>
            <h3 className="font-bold text-lg mb-1 text-gray-900 dark:text-gray-100">Carlos Mendez</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Structured Data Specialist & Schema Markup Expert</p>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-12">
        ...
        <ul className="space-y-2 text-blue-600 dark:text-blue-400">
          <li><a href="#rich-snippets-impact" className="hover:underline">Rich Snippets Impact: 20-35% CTR Increase</a></li>
          <li><a href="#what-is-structured-data" className="hover:underline">What Is Structured Data & Why It Matters</a></li>
          <li><a href="#schema-types-shopify" className="hover:underline">7 Essential Schema Types for Shopify</a></li>
          <li><a href="#product-schema" className="hover:underline">Product Schema: The Foundation</a></li>
          <li><a href="#review-schema" className="hover:underline">Review Schema & Star Ratings</a></li>
          <li><a href="#faq-schema" className="hover:underline">FAQ Schema for Product Pages</a></li>
          <li><a href="#breadcrumb-schema" className="hover:underline">Breadcrumb Schema for Navigation</a></li>
          <li><a href="#organization-schema" className="hover:underline">Organization Schema (Homepage)</a></li>
          <li><a href="#json-ld-implementation" className="hover:underline">JSON-LD: Google's Recommended Format</a></li>
          <li><a href="#testing-validation" className="hover:underline">Testing & Validating Schema Markup</a></li>
          <li><a href="#common-errors" className="hover:underline">Common Schema Errors & Fixes</a></li>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <div className="bg-yellow-50 dark:bg-yellow-950/30 border-l-4 border-yellow-500 rounded-lg p-8 my-8">
          ...
          <ul className="space-y-3 text-gray-700 dark:text-gray-300">
            <li><strong>20-35%</strong> average CTR increase with rich snippets</li>
            <li><strong>3x more likely</strong> to appear in rich results with schema markup</li>
            <li><strong>25%</strong> CTR boost (Rotten Tomatoes case study: 100,000 pages)</li>
            <li><strong>30%</strong> organic traffic increase for retail sites using structured markup</li>
            <li><strong>15%</strong> of searches show AI summaries using structured data</li>
            <li><strong>35%</strong> higher CTR for rich snippets with stars and prices</li>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Answer user intent:</strong> FAQ snippets answer questions directly in search</li>
          <li><strong>AI search integration:</strong> 15% of searches use structured data for AI summaries</li>
  ...
  "review": [
    {
      ...
      "reviewBody": "Best coffee I've ever had! Smooth, rich flavor with no bitterness. Perfect for morning pour-over."
          ...
          <table className="min-w-full border border-gray-300 dark:border-gray-700">
            ...
            <tbody className="text-gray-700 dark:text-gray-300">
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Required</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Product title in results</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">image</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Required</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Visual in rich results</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">offers (with price)</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">✅ Required</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Price display, availability</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">aggregateRating</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">⚠️ Recommended</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Star ratings (+35% CTR)</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">review</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">⚠️ Recommended</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Trust signals</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">brand</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">⚠️ Recommended</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Brand visibility</td>
              </tr>
              <tr>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">sku</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Optional</td>
                <td className="border border-gray-300 dark:border-gray-700 px-4 py-2">Product identification</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>reviewCount:</strong> Total number of reviews</li>
        ...
        <div className="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 rounded-lg p-8 my-8">
          ...
          <ul className="space-y-3 text-gray-700 dark:text-gray-300">
            <li><strong>No self-reviews:</strong> Don't write your own product reviews</li>
            <li><strong>Real customer reviews only:</strong> Google penalizes fake reviews</li>
            <li><strong>Match visible content:</strong> Schema ratings must match ratings shown on page</li>
            <li><strong>Third-party reviews preferred:</strong> Reviews from verified platforms (Trustpilot, Yotpo) have more weight</li>
    ...
    },
    {
      ...
      "acceptedAnswer": {
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Include keywords naturally:</strong> Use question variations people actually search</li>
          <li><strong>Concise answers:</strong> 40-100 words per answer (readable in SERP)</li>
  ...
  "sameAs": [
    ...
    "https://www.linkedin.com/company/yourstore"
        ...
        <div className="space-y-4 mb-8">
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-3">
              Edit theme files (e.g., <code>product.liquid</code>) and add JSON-LD scripts manually.
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Pros:</strong> Full control, no app fees<br/>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Pros:</strong> Easy, no coding required, automatic updates<br/>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Pros:</strong> Fully automated, optimized for rich results, includes validation<br/>
              <strong>Cons:</strong> Requires SEOLOGY.AI subscription
            </p>
          </div>
        </div>
        ...
        <ol className="list-decimal list-inside space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          ...
          <li><strong>Optimize warnings:</strong> Add recommended fields (yellow warnings) for better results</li>
          <li><strong>Deploy to live site:</strong> Add schema to production</li>
        ...
        <div className="space-y-6 mb-8">
          <div className="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 p-6 rounded">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              <strong>Error:</strong> "The field 'offers' is required"
            </p>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 p-6 rounded">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              <strong>Error:</strong> Use Schema.org URL format
            </p>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 p-6 rounded">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              <strong>Error:</strong> Fake reviews, self-reviews
            </p>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-950/30 border-l-4 border-yellow-500 p-6 rounded">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              <strong>Warning:</strong> Optional but highly recommended
            </p>
            <p className="text-gray-700 dark:text-gray-300">
              <strong>Fix:</strong> Add aggregateRating with ratingValue and reviewCount for star ratings (35% CTR boost)
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950/30 dark:to-orange-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-8 my-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>☐ Add Product schema to ALL products (scale implementation)</li>
                <li>☐ Add Review schema to products with individual customer reviews</li>
                <li>☐ Create FAQ sections on top 20 product pages (3-5 FAQs each)</li>
                <li>☐ Add FAQ schema to match visible FAQ content</li>
                <li>☐ Implement BreadcrumbList schema on all product/category pages</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>☐ Add FAQ schema to blog posts and guides</li>
                <li>☐ Monitor CTR in Google Search Console (compare before/after)</li>
                <li>☐ Track rich result impressions and clicks</li>
                <li>☐ Fix any schema errors flagged in GSC</li>
                <li>☐ Update schema as products change (price, availability, reviews)</li>
                <li>☐ Document schema strategy for future products</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-2xl p-12 my-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Link
              ...
              className="bg-white text-yellow-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-50 transition-colors inline-block shadow-lg"
            >
              Start Free 14-Day Trial →
            </Link>
            <Link
              href="/demo"
              className="bg-yellow-700 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-800 transition-colors inline-block border-2 border-white/30"
            >
              Watch Demo
            </Link>
          </div>
          ...
          <div className="flex items-center justify-center gap-8 text-sm text-yellow-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>20-35% CTR increase with rich snippets</span>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose border-t border-gray-200 dark:border-gray-700 pt-8 mt-16">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1 text-gray-900 dark:text-gray-100">About the Author: Carlos Mendez</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Structured Data Specialist & Schema Markup Expert</p>
              <p className="text-sm text-gray-700 dark:text-gray-300">
