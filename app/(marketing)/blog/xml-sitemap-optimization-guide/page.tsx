    ...
    <article className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 pt-32 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-black dark:text-white leading-tight">
          ...
          <p className="text-xl text-black/60 dark:text-white/60 mb-8 leading-relaxed">
            A poorly optimized sitemap wastes your crawl budget and leaves pages unindexed. This guide shows how to <strong className="text-black dark:text-white">build perfect XML sitemaps</strong> that get every important page crawled and indexed fast.
          </p>
          <div className="mb-12">
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 px-8 py-4 bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl"
            >
      ...
      <div className="bg-white dark:bg-black text-black dark:text-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 mb-12 rounded-r-lg">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-0">TL;DR</h2>
              ...
              <p className="text-black/60 dark:text-white/60 mb-0">
            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
                  <FileCode className="w-8 h-8 text-black dark:text-white" />
                ...
                <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 my-8 rounded-r-lg">
                  <p className="text-black/60 dark:text-white/60 mb-0">
              ...
              <section>
                ...
                <div className="bg-black/5 dark:bg-white/5 text-black dark:text-white p-6 rounded-xl my-6 overflow-x-auto border border-black/10 dark:border-white/10">
  ...
  <url>
    ...
    <priority>0.6</priority>
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;urlset&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Purpose:</strong> Root element that wraps all URL entries
                    </p>
                    <p className="text-black/60 dark:text-white/60">
                      <strong className="text-black dark:text-white">Required attribute:</strong> xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
                    </p>
                  </div>
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;url&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Purpose:</strong> Container for each URL entry
                    </p>
                    <p className="text-black/60 dark:text-white/60">
                      <strong className="text-black dark:text-white">Note:</strong> You can have up to 50,000 URLs per sitemap file
                    </p>
                  </div>
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;loc&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Purpose:</strong> The full URL of the page (REQUIRED for every URL entry)
                    </p>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Format:</strong> Must be absolute URL (https://example.com/page), not relative (/page)
                    </p>
                    <p className="text-black/60 dark:text-white/60">
                      <strong className="text-black dark:text-white">Encoding:</strong> Must escape special characters (&amp; becomes &amp;amp;)
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;lastmod&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Purpose:</strong> Date of last modification (helps Google prioritize recent updates)
                    </p>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Format:</strong> YYYY-MM-DD or YYYY-MM-DDTHH:MM:SS+00:00 (ISO 8601)
                    </p>
                    <p className="text-black/60 dark:text-white/60">
                      <strong className="text-black dark:text-white">Best practice:</strong> Only include if you accurately track last modified dates--false dates hurt more than help
                    </p>
                  </div>
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;changefreq&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Purpose:</strong> How frequently the page changes (hint to crawlers, not directive)
                    </p>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                      <strong className="text-black dark:text-white">Values:</strong> always, hourly, daily, weekly, monthly, yearly, never
                    </p>
                    <p className="text-black/60 dark:text-white/60">
                      <strong className="text-black dark:text-white">Reality check:</strong> Google mostly ignores this now--focus on lastmod instead
                    </p>
                  </div>
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;priority&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
              ...
              <section>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl my-6 border border-black/10 dark:border-white/10">
                ...
                <p className="text-lg text-black/60 dark:text-white/60 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
                  ...
                  <Image className="w-8 h-8 text-black dark:text-white" />
  ...
  <url>
    ...
    <image:image>
      ...
      <image:title>Widget Demo Photo</image:title>
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;image:loc&gt; (REQUIRED)</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;image:caption&gt; (Optional)</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;image:title&gt; (Optional)</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;image:geo_location&gt; (Optional)</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;image:license&gt; (Optional)</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
  ...
  <url>
    ...
    <video:video>
      ...
      <video:uploader info="https://example.com/about">Example Company</video:uploader>
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;video:thumbnail_loc&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;video:title&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;video:description&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-black/10 dark:border-white/10">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">&lt;video:content_loc&gt; OR &lt;video:player_loc&gt;</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
              ...
              <section>
                <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
                  <FolderTree className="w-8 h-8 text-black dark:text-white" />
  ...
  <sitemap>
    ...
    <lastmod>2024-10-22T16:00:00+00:00</lastmod>
              ...
              <section>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-6 rounded-xl my-6 border border-black/10 dark:border-white/10">
                  <ol className="space-y-3 text-black/60 dark:text-white/60">
                ...
                <div className="bg-black/5 dark:bg-white/5 text-black dark:text-white p-6 rounded-xl my-6 border border-black/10 dark:border-white/10">
                  <pre className="text-sm">
{`User-agent: *
Allow: /
...
Sitemap: https://example.com/sitemap-videos.xml`}
              ...
              <section>
                ...
                <div className="space-y-6 my-8">
                  <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 rounded-r-lg">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">❌ Mistake 1: Including Blocked or Noindex Pages</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 rounded-r-lg">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">❌ Mistake 2: 404 Errors in Sitemap</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 rounded-r-lg">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">❌ Mistake 3: Redirect Chains in Sitemap</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
                  ...
                  <div className="bg-black/5 dark:bg-white/5 border-l-4 border-black dark:border-white p-6 rounded-r-lg">
                    <h4 className="text-xl font-bold mb-3 text-black dark:text-white">❌ Mistake 4: Not Updating Lastmod Dates</h4>
                    <p className="text-black/60 dark:text-white/60 mb-3">
              ...
              <section>
                ...
                <div className="bg-black dark:bg-white p-8 rounded-2xl text-white dark:text-black border border-black/10 dark:border-white/10">
                  ...
                  <Link
                    href="/sign-up"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-white dark:bg-black text-black dark:text-white font-bold rounded-lg hover:bg-black/10 dark:hover:bg-white/10 transition-all duration-300 shadow-lg border border-black/10 dark:border-white/10"
                  >
                    Try SEOLOGY Free
                    <ArrowRight className="w-5 h-5" />
                  </Link>
              ...
              <section>
                ...
                <ul className="space-y-2">
                  <li><Link href="/blog/crawl-budget-optimization-guide" className="text-black dark:text-white hover:text-black/60 dark:hover:text-white/60">Crawl Budget Optimization Guide</Link></li>
                  <li><Link href="/blog/robots-txt-configuration-guide" className="text-black dark:text-white hover:text-black/60 dark:hover:text-white/60">Robots.txt Configuration Guide</Link></li>
                  <li><Link href="/blog/technical-seo-audit-checklist-2025" className="text-black dark:text-white hover:text-black/60 dark:hover:text-white/60">Technical SEO Audit Checklist</Link></li>
                  <li><Link href="/blog/site-architecture-seo-best-practices" className="text-black dark:text-white hover:text-black/60 dark:hover:text-white/60">Site Architecture SEO Best Practices</Link></li>
                </ul>
              </section>
              <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedPosts.map((post) => (
              <Link
                key={post.slug}
                href={`/blog/${post.slug}`}
                className="group bg-black/5 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-black/10 dark:border-white/10 hover:border-black/20 dark:hover:border-white/20 transition-all duration-300"
              >
                <div className="text-sm text-black/60 dark:text-white/60 mb-2">{post.date}</div>
                <h3 className="text-lg font-bold mb-2 text-black dark:text-white group-hover:text-black/60 dark:group-hover:text-white/60 transition-colors">
                  {post.title}
                </h3>
