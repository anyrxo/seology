...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full px-4 pt-4">
      <div className="w-full rounded-2xl border border-white/10 dark:border-white/5 bg-white/80 dark:bg-black/60 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-black/40 shadow-lg shadow-black/5 dark:shadow-black/20">
        <div className="container mx-auto">
          <div className="flex items-center justify-between h-16 px-4">
          {/* Logo */}
            <Link href="/" className="flex items-center gap-2 group">
            <span className="text-2xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent group-hover:from-blue-500 group-hover:via-purple-500 group-hover:to-cyan-500 transition-all duration-300">
              Seology.ai
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            <ThemeSwitcher />
            <Link href="/sign-up">
              <Button className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 hover:from-blue-500 hover:via-purple-500 hover:to-cyan-500 text-white shadow-lg hover:shadow-xl hover:shadow-blue-500/50 transition-all duration-300 font-semibold px-6 py-2.5 rounded-lg">
                Try SEOLOGY Free
              </Button>
            </Link>
          </div>
